...
namespace HomeCinema
{
    public partial class frmMovieInfo : Form
    {
        ...
        {
            string item = GlobalVars.GetStringInputBox(list, lb.Items.Cast<string>().ToList(), caption);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (MOVIE_ID > 0)
            {
                ...
                foreach (var item in lboxProducer.Items)
                {
                    if (item != null)
        ...
        private void btnFetchData_Click(object sender, EventArgs e)
        {
            ...
            {
                LoadListBoxItems(mediaInfo.Studio, lboxStudio);
            }
            // Set Director
